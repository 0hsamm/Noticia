 ...
 * relacionadas con los usuarios comentaristas
...
export class UsuarioComentaristaService {
  ...
  /**
   * URL base del endpoint de usuarios comentaristas.
   */
  private readonly apiUrl = 'http://localhost:8081/usuariocomentarista';

  /**
   * Obtiene la lista completa de usuarios comentaristas.
   *
  ...
  /**
   * Actualiza un usuario comentarista existente mediante su identificador.
   *
  ...
  /**
   * Elimina un usuario comentarista según su identificador.
   *
