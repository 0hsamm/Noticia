 ...
 * relacionadas con los usuarios normales
...
export class UsuarioNormalService {
  ...
  /**
   * URL base del endpoint de usuarios normales.
   */
  private readonly apiUrl = 'http://localhost:8081/usuarionormal';

  /**
   * Obtiene la lista completa de usuarios normales.
   *
  ...
  /**
   * Actualiza un usuario normal existente mediante su identificador.
   *
  ...
  /**
   * Elimina un usuario normal según su identificador.
   *
