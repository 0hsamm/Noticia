 ...
 * relacionadas con los usuarios editores
...
export class UsuarioEditorService {
  ...
  /**
   * URL base del endpoint de usuarios editores.
   */
  private readonly apiUrl = 'http://localhost:8081/usuarioeditor';

  /**
   * Obtiene la lista completa de usuarios editores.
   *
  ...
  /**
   * Actualiza un usuario editor existente mediante su identificador.
   *
  ...
  /**
   * Elimina un usuario editor según su identificador.
   *
