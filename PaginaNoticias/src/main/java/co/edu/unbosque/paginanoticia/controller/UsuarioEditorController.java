...
public class UsuarioEditorController {
	...
	@PostMapping("/crear")
	public ResponseEntity<String> crearUsuarioEditor(@RequestParam String nombre, @RequestParam String contrasena,
	...
	public ResponseEntity<String> actualizarUsuarioEditor(@RequestParam Long id, @RequestParam String nombre,
