...
public class ComentarioController {
	...
	public ResponseEntity<String> crearComentario(@RequestParam String contenido, @RequestParam LocalDateTime fecha,
			...
			@RequestParam(required = false) TipoHoroscopo signoHoroscopo, @RequestParam(required = false) Long horoscopoId,
			@RequestParam TipoPublicacion tipoPublicacion) {
		ComentarioDTO nuevo = new ComentarioDTO(contenido, fecha, nombreComentarista, tituloNoticia, signoHoroscopo,
				tipoPublicacion);
